...
namespace Owin.Security.Providers.LnAuth
{
    ...
    {
        public static IAppBuilder UseLnAuthAuthentication(this IAppBuilder app, LnAuthAuthenticationOptions options)
        {
            if (app == null)
        ...
        {
            return app.UseLnAuthAuthentication(new LnAuthAuthenticationOptions{ClientId = clientId, ClientSecret = clientSecret});
        }
    }
}