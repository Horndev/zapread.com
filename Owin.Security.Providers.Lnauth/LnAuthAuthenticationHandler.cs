    ...
    public class LnAuthAuthenticationHandler : AuthenticationHandler<LnAuthAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var cookieOptions = new CookieOptions{HttpOnly = true, Secure = Request.IsSecure, SameSite = SameSiteMode.None, };
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            var authorizationEndpoint = Options.Endpoints.AuthorizationEndpoint + "?client_id=" + Uri.EscapeDataString(Options.ClientId) + "&redirect_uri=" + Uri.EscapeDataString(redirectUri) + "&scope=" + Uri.EscapeDataString(scope) + "&state=" + Uri.EscapeDataString(state);
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            ...
            {SignInAsAuthenticationType = Options.SignInAsAuthenticationType, RedirectUri = ticket.Properties.RedirectUri};
