...
var WrappedRange = /** @class */ (function () {
    ...
    WrappedRange.prototype.insertNode = function (node) {
        ...
        if (info.rightNode) {
          ...
          //console.log('d: WrappedRange.prototype.insertNode info rn');
        }
        else {
          info.container.appendChild(node);
          //console.log('d: WrappedRange.prototype.insertNode appendChild');
        }
        return node;
    };
    /**
...
var HintPopover = /** @class */ (function () {
  ...
  HintPopover.prototype.replace = function () {
     //var nnnode = document.createElement('span');
      //this.context.invoke('editor.insertNode', nnnode);
    //this.context.invoke('editor.insertText', "");
      ...
      if ($item.length) {
            ...
            //this.lastWordRange.pasteHTML("<span></span>");
