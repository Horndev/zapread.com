    ...
    public partial class Startup
    {
        ...
        public class SystemWebCookieManager : ICookieManager
        {
            ...
            public void DeleteCookie(IOwinContext context, string key, CookieOptions options)
            {
                ...
                AppendResponseCookie(context, key, string.Empty, new CookieOptions{Path = options.Path, Domain = options.Domain, Expires = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc), });
            }
        }
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions{AuthenticationType = DefaultAuthenticationTypes.ApplicationCookie, LoginPath = new PathString("/Account/Login"), CookieName = "ZapreadUserAuth", CookieManager = new SystemWebCookieManager(), Provider = new CookieAuthenticationProvider{// Don't redirect if we are using the REST API
            OnApplyRedirect = ctx =>
            {
            ...
            {Header = "X-ApiKey", HeaderKey = "ZR", Provider = new ApiKeyAuthenticationProvider()
            {OnValidateIdentity = APIKeyAuthorizationHandler.ValidateIdentity, OnGenerateClaims = APIKeyAuthorizationHandler.GenerateClaims, }});
            ...
            {ClientId = System.Configuration.ConfigurationManager.AppSettings["OAuth_Google_ClientId"], ClientSecret = System.Configuration.ConfigurationManager.AppSettings["OAuth_Google_Secret"], });
            ...
            {ClientId = System.Configuration.ConfigurationManager.AppSettings["OAuth_Zapread_LnAuth_ClientId"], ClientSecret = System.Configuration.ConfigurationManager.AppSettings["OAuth_Zapread_LnAuth_Secret"], });
